...
- Battle-tested against a real 60k-item / 262 GB iPhone library — see [docs/LESSONS-LEARNED.md](docs/LESSONS-LEARNED.md) for the full retrospective (5 root causes, what worked, reusable principles)
